...
(function (h) {
    ...
    function Da(a) {
        var b = m.defaults.oLanguage,
            c = a.sZeroRecords;
        !a.sEmptyTable && (c && "Kayıt Bulunamadı" === b.sEmptyTable) && E(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function pb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input style="max-width:180px" placeholder="Tabloda Ara" type="search" class="' + b.sFilterInput + '"/>',
            j = d.sSearch,
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "_TOTAL_ toplam girdiden _START_ ile _END_ arasındakiler gösteriliyor",
            sInfoEmpty: "0 toplam girdiden 0 ile 0 arasındakiler gösteriliyor",
            ...
            sSearch: "<span class='d-none'>Tabloda ara:</span>",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Hiç bir eşleşen kayıt bulunamadı"
        },
    ...
    h.extend(m.ext.classes, {
        ...
        sInfo: "dataTables_info font-normal",
        sPaging: "dataTables_paginate font-normal paging_",
...
(function (b) {
    ...
    b.extend(!0, f.defaults, {
        dom: "<'row'<'col-12 col-lg-6 py-0 py-md-3 d-flex justify-content-start pl-1'l><'col-12 col-lg-6 py-1 py-md-3 d-flex justify-content-end justify-content-sm-end pr-1'f>><'row'<'col-xs-12 col-12'tr>><'row'<'col-12 py-2 text-muted fw-300'i><'col-12 py-1'p>>",
        renderer: "bootstrap"
    });
